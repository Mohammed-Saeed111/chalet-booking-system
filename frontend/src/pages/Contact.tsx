...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In real app, this would send the form data to a backend
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{t('contact.address')}</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    info@chaletbooking.com<br />
                    support@chaletbooking.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{t('contact.business_hours')}</h3>
                  <p className="text-gray-600 dark:text-gray-300">
