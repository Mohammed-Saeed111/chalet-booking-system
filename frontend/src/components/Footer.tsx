...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 dark:bg-gray-900 text-white" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">{t('navbar.title')}</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className={`flex flex-col md:flex-row justify-between items-center ${isRTL ? 'md:flex-row-reverse' : ''}`}>
            <p className="text-gray-400 text-sm">
              © 2024 {t('navbar.title')}. {t('footer.all_rights_reserved')}
            </p>
