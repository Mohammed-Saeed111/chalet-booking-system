...
// // Distribute the 11 images among 6 chalets (some overlap for demo)
// import { chaletImages } from "./chaletImages";
...
export const chalets: Chalet[] = [
	{
		...
		price: 1200,
		images: [chaletImages[0], chaletImages[1]],
		rating: 4.7,
		bedrooms: 2,
		bathrooms: 2,
		guests: 6,
	...
	},
	{
		...
		price: 1500,
		images: [chaletImages[2], chaletImages[3]],
		rating: 4.8,
		bedrooms: 3,
		bathrooms: 2,
		guests: 8,
	...
	},
	{
		...
		price: 1000,
		images: [chaletImages[4], chaletImages[5]],
		rating: 4.5,
		bedrooms: 2,
		bathrooms: 1,
		guests: 5,
	...
	},
	{
		...
		price: 1800,
		images: [chaletImages[6], chaletImages[7]],
		rating: 4.9,
		bedrooms: 4,
		bathrooms: 3,
		guests: 10,
	...
	},
	{
		...
		price: 1100,
		images: [chaletImages[8], chaletImages[9]],
		rating: 4.6,
		bedrooms: 3,
		bathrooms: 2,
		guests: 7,
	...
	},
	{
		...
		price: 1300,
		images: [chaletImages[10], chaletImages[0]],
		rating: 4.7,
		bedrooms: 2,
		bathrooms: 2,
		guests: 6,
